<template>
    <div>
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="#" style="font-size: 20px" @click="navigateToMaster()"><font-awesome-icon icon="arrow-circle-left" /> return</a>
        ...
        <div class="right-sidebar">
            <div class="container-fluid">
                <div class="row" style="padding-top: 15px; border-bottom: 1px solid rgba(0,0,0,.06)">
                    <div class="col-md-12">
                        <span>Preview</span>
                    </div>
                </div>
                ...
                <div class="row" style="align-items: center; margin-left: auto; margin-right: auto; width: 80vh; height: 70vh; margin-bottom: 10px; padding: 10px;">
                    <div v-if="processing">
                        <p>Processing...</p>
                    </div>
                    <div class="boxStyle" :style="box"></div>
                </div>
                <div class="row" style="margin-top: 25px; padding-top: 20px; border: 1px dashed #1d4354">
                    ...
                    <div id="col-setup" class="col-md-4">
                        <button type="submit" class="btn btn-dark float-right btn-lg" style="font-size: 12px; border-radius: 0" @click.stop.prevent="addTestData()">
                            <font-awesome-icon icon="wrench" /> setup test
                        </button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row display-master-data">
                            <div class="col-md-12">
                                <div class="fixed-top" style="color: rgba(255, 255, 255, 0.75); box-shadow: black 0 8px 6px -6px; margin-top: 61px; margin-right: 40%; background-color: rgb(29, 67, 84)">
                                    <div class="row pointer" style="padding-left: 10px; padding-top: 15px; " @click.stop.prevent="addDetailData()">
                                        <div class="col-md-10">
                                            <p style=" font-size: 18px;">Master detail list</p>
                                        </div>
                                        <div class="col-md-2">
                                            <p style="font-size: 14px"><font-awesome-icon icon="plus-circle"/> <span>Add sequence</span></p>
                                        </div>
                                    </div>
<!--                                    <p style=" font-size: 18px; border-bottom: 1px solid #b4bcc3; padding-bottom: 5px; padding-left: 10px; padding-top: 10px">Master detail list</p>-->
                                    <div style="padding-left: 10px;">
                                        <div class="detail-wrapper">
                                            <div class="row">
                                                <div id="col-sq-start-top" class="col-md-2 align-self-center">
                                                    <div class="detail-duration">
                                                        <p class="form-text" style="color: rgb(173, 176, 179); font-size: 14px">sequence #</p>
                                                    </div>
                                                </div>
                                                <div id="col-detail-start-top" class="col-md-5 align-self-center">
                                                    <div class="detail-duration">
                                                        <p class="form-text" style="color: rgb(173, 176, 179); font-size: 14px">entry name</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="col-detail-end-top" class="col-md-2 align-self-center">
                                                    <div class="detail-repeat-count">
                                                        <p class="form-text" style="color: rgb(173, 176, 179); font-size: 14px">repeat count</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div :key="index"
                                        ...
                                        <div class="detail-wrapper">
                                            <div class="row" style="margin-bottom: 15px; margin-top: 15px">
                                                <div id="col-sq-start" class="col-md-2 align-self-center">
                                                    <div class="detail-duration">
                                                ...
                                                <div id="col-detail-start" class="col-md-5 align-self-center">
                                                    <div class="detail-duration">
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="col-detail-down-mid" class="col-md-5 align-self-center">
...
<style scoped>
    .boxStyle {
        margin-top: 10px; padding: 10px; width: 73vh; height: 70vh; background-color: #343a40;
    }
    .left-sidebar {
